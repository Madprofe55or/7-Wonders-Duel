...
WonderBuildingState::WonderBuildingState(Game * game, CardPickerState * cardpickerstate, GamePlayingState * gameplayingstate)
{
	...
	if (p_game->world.canBuild(*p_player, *p_player->playerWonderDeck[0]) && p_player->playerWonderDeck[0]->builtWonder == false && p_game->world.wonderCount<8) canBuildWonder1 = true;
	else canBuildWonder1 = false;
	if (p_game->world.canBuild(*p_player, *p_player->playerWonderDeck[1]) && p_player->playerWonderDeck[1]->builtWonder == false && p_game->world.wonderCount<8) canBuildWonder2 = true;
	else canBuildWonder2 = false;
	if (p_game->world.canBuild(*p_player, *p_player->playerWonderDeck[2]) && p_player->playerWonderDeck[2]->builtWonder == false && p_game->world.wonderCount<8) canBuildWonder3 = true;
	else canBuildWonder3 = false;
	if (p_game->world.canBuild(*p_player, *p_player->playerWonderDeck[3]) && p_player->playerWonderDeck[3]->builtWonder == false && p_game->world.wonderCount<8) canBuildWonder4 = true;
